...
class LLMStrategy(Strategy):
    ...
    def description(self) -> str:
        return "LLM-based prediction using google/gemma-3-12b with batch processing"
    ...
    def _load_model(self) -> None:
        ...
        # Try to load with quantization if bitsandbytes is available
        try:
            ...
            logger.warning("This will use more memory. Install bitsandbytes for 4-bit quantization.")
            ...
            self.model = AutoModelForCausalLM.from_pretrained(
                ...
                local_files_only=True,  # Use local cache
                low_cpu_mem_usage=True,
                torch_dtype=torch.float16,  # Use half precision at least
            )
