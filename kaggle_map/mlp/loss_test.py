...
def test_listmle_loss_with_different_k():
...
def test_listmle_loss_perfect_ranking():
...
def test_listmle_loss_batch_independence():
...
def test_listmle_loss_edge_cases():
    """Test edge cases."""
    loss_fn = ListMLELoss()
